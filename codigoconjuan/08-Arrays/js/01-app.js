// Al igual que los objetos los arreglos forman una parte muy importante
//  en cualquier lenguaje de programación
// Un ejemplo de un arreglo es un carrito de compras, sirve para agrupar elementos del mismo tipo.
// También la forma en que facebook muestra un listado de amigos o 
// personas que le dieron Me Gusta a tu última foto, seguramente es un arreglo.
...
// El arreglo anterior fue de números, también puedes crear uno de Strings por ejemplo 
// y se puede crear utilizando la palabra new
...
// Personalmente encuentro más fácil de utilizar la sintaxis de llaves
// asi que esa sera la que estaremos utilizando, pero recuerda, 
// un arreglo es una forma de agrupar grandes cantidades de información en una sola variable.
